...
import 'package:flutter_app/Quizzes/QSocietyData.dart';
...
class QSociety extends StatefulWidget {
  const QSociety({super.key});

  @override
  QSocietyState createState() => QSocietyState();
}

class QSocietyState extends State<QSociety> {
  QSocietyData q = QSocietyData();
