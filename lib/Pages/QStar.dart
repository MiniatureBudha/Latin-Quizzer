...
import 'package:flutter_app/Quizzes/QStarData.dart';
...
class QStar extends StatefulWidget {
  const QStar({super.key});

  @override
  QStarState createState() => QStarState();
}

class QStarState extends State<QStar> {
  QStarData q = QStarData();
