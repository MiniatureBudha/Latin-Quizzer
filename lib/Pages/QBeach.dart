...
import 'package:flutter_app/Quizzes/QBeachData.dart';
...
class QBeach extends StatefulWidget {
  const QBeach({super.key});

  @override
  QBeachState createState() => QBeachState();
}

class QBeachState extends State<QBeach> {
  QBeachData q = QBeachData();
