...
import 'package:flutter_app/Quizzes/QBaldData.dart';
...
class QBald extends StatefulWidget {
  const QBald({super.key});

  @override
  QBaldState createState() => QBaldState();
}

class QBaldState extends State<QBald> {
  QBaldData q = QBaldData();
