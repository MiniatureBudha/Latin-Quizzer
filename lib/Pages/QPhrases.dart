...
import 'package:flutter_app/Quizzes/QPhrasesData.dart';
...
class QPhrases extends StatefulWidget {
  const QPhrases({super.key});

  @override
  QPhrasesState createState() => QPhrasesState();
}

class QPhrasesState extends State<QPhrases> {
  QPhrasesData q = QPhrasesData();
